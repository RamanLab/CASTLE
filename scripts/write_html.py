      ...
      <div class="site-section">
		<div class="col-lg-4 sidenav">
            ...
            <div id="downloads" class="container">			
					...
					<img src="../img/elements/growth_rate.PNG" width="20" style="vertical-align: middle"><font size="4"> Growth Rate: {gr:}</font>
                    </p>
                    <br>
                    <p style="line-height: 10px">
					<img src="../img/elements/model_link.PNG" width="20" style="vertical-align: middle"><font size="4"><a href="{link:}" target="blank"><font color="black"><u>{link:}</u></font></a></font>
                    </p>
                   <br>
