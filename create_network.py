...
for idx, org in enumerate(os.listdir(r'CSV/')):
    res = master[master[0] == org.replace('_', '&nbsp;')][10]
    if res.any() and res.values[0] == 'vmh':
        ...
        try:
            ...
            for id_, gene in enumerate(pd.unique(dlg.values.ravel())):
                ...
                gene_functions[gene] = Counter(subsystems).most_common(1)[0][0]
                print(id_)
